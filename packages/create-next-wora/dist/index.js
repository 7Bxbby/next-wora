...
function shouldCopy(src, baseDir) {
...
async function chooseTemplate(templates, defaultTemplate) {
...
function printHelp(templates, defaultTemplate) {
    ...
    if (templates.length > 0) {
        console.log(`Available templates: ${templates.join(", ")}${defaultTemplate ? ` (default: ${defaultTemplate})` : ""}`);
    }
}
async function run() {
